"""
Figure: Joint risk-score distribution (density curves) with η₁, η₂ thresholds.
IEEE single-column width, clean layout, no text overlap.

Usage:
    python scripts/fig_method_fig4.py

Output:
    exp_data/TCRNet_Final_Figures/figures/fig_method_fig4.pdf
"""
