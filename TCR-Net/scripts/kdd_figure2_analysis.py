"""
KDD-style Figure 2 — Ablation & Mechanism Analysis

Layout:
  ┌──────────────────────┬──────────────────────┐
  │  (a) Ablation        │  (b) Per-class F1    │
  │  Δ Macro-F1 + Δ HRR  │  grouped bars        │
  │  (dual bar chart)    ├──────────────────────┤
  │                      │  (c) Mechanism       │
  │                      │  subset validation   │
  └──────────────────────┴──────────────────────┘

: python kdd_figure2_analysis.py
"""
